...
namespace IThermal.Tests
{
    ...
    public class IAPWS97Tests
    {
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2T97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2HL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2SL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2VL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2CPL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2CVL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2KSL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2ETAL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2HG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2SG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2VG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2CPG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2CVG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2KSG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.P2ETAG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2P97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2HL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2SL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2VL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2CPL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2CVL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2KSL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2ETAL97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2HG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2SG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2VG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2CPG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2CVG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2KSG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.T2ETAG97(input1), delta);
        }

        [TestMethod()]
        [DataRow(5, 500, 300)]
        public void T2ETAG97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.T2ETAG97(input1), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PT2H97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PT2S97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PT2V97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PT2CP97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PT2CV97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PT2KS97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PT2ETA97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PT2X97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PH2T97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PH2S97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PH2V97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PH2X97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PS2T97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PS2H97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PS2V97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PS2X97(input1, input2), delta);
        }


        [TestMethod()]
        [DataRow(513.741750296760, 5, 0.07)]
        public void PV2T97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.PV2T97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(3466.497864022123, 5, 0.07)]
        public void PV2H97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.PV2H97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(7.018857248529, 5, 0.07)]
        public void PV2S97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.PV2S97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.PV2X97(input1, input2), delta);
        }


        [TestMethod()]
        [DataRow(212.384536014978, 2, 0.8)]
        public void PX2T97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.PX2T97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(2420.431684833667, 2, 0.8)]
        public void PX2H97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.PX2H97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(5.560736288345, 2, 0.8)]
        public void PX2S97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.PX2S97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(0.079899785579, 2, 0.8)]
        public void PX2V97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.PX2V97(input1, input2), delta);
        }


        [TestMethod()]
        [DataRow(7.947560130182, 500, 3400)]
        public void TH2P97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TH2P97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(6.730033591752, 500, 3400)]
        public void TH2S97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TH2S97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(0.042064308369, 500, 3400)]
        public void TH2V97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TH2V97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.TH2X97(input1, input2), delta);
        }


        [TestMethod()]
        [DataRow(0.605042152158, 500, 8)]
        public void TS2P97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TS2P97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(3483.275536964718, 500, 8)]
        public void TS2H97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TS2H97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(0.587046040535, 500, 8)]
        public void TS2V97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TS2V97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.TS2X97(input1, input2), delta);
        }


        [TestMethod()]
        [DataRow(6.756480608878, 500, 0.05)]
        public void TV2P97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TV2P97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(3414.115428777327, 500, 0.05)]
        public void TV2H97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TV2H97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(6.818876042048, 500, 0.05)]
        public void TV2S97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TV2S97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.TV2X97(input1, input2), delta);
        }


        [TestMethod()]
        [DataRow(8.587708329557, 300, 0.9)]
        public void TX2P97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TX2P97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(2609.093502191549, 300, 0.9)]
        public void TX2H97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TX2H97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(5.460661310194, 300, 0.9)]
        public void TX2S97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TX2S97(input1, input2), delta);
        }

        [TestMethod()]
        [DataRow(0.019637180568, 300, 0.9)]
        public void TX2V97Test(double expection, double input1, double input2)
        {
            Assert.AreEqual(expection, IAPWS97.TX2V97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.HS2P97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.HS2T97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.HS2V97(input1, input2), delta);
        }
        ...
        {
            Assert.AreEqual(expection, IAPWS97.HS2X97(input1, input2), delta);
        }
    }
}